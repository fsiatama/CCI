...
Ext.ux.ScriptManager = Ext.extend(Ext.util.Observable, {
    ...
    */
     ...
     * @param {String} url Url of the file to be loaded or the config object with array of urls ans other config options
     * @param {Function} callback Callback function which will be called once all the files are loaded
     *
     * @returns Null
     */
