 /**
* @class Column2DNoRightBorder
* @author FusionCharts Technologies LLP, www.fusioncharts.com
* @version 3.2
*
* Copyright (C) FusionCharts Technologies LLP, 2010
*
* Column2DNoRightBorder extends the movie clip class and represents a single
* 2D Column to be drawn on the chart. It takes in the required
* parameters (dimensions) and draws a column without a right border
*/
//Import required classes
import com.fusioncharts.extensions.MathExt;
import com.fusioncharts.extensions.DrawingExt;
class com.fusioncharts.core.chartobjects.Column2DNoRightBorder extends MovieClip 
{
	//Instance variables
	...
	* in local variables.
	*/
	function Column2DNoRightBorder (target : MovieClip, w : Number, h : Number, borderColor : String, borderAlpha : Number, borderThickness : Number, bgColor : Array, bgAlpha : Array, bgRatio : Array, bgAngle : Number, drawBottomBorder : Boolean, isBorderDashed : Boolean, dashLen : Number, dashGap : Number)
	{
	...
	*/
	public function draw () : Void 
	{
		...
		if (this.isBorderDashed)
		{
			...
			//Do not draw this: DrawingExt.dashTo (this.mc, w / 2, h, w / 2, 0, this.dashLen, this.dashGap);
			//Instead, just move to that location
			this.mc.moveTo(w / 2, 0);
			if (drawBottomBorder)
			{
