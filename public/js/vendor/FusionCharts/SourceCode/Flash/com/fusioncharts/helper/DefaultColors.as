...
class com.fusioncharts.helper.DefaultColors
{
	...
	/**
	 * Sets the default list of colors for the chart palette. These colors
	 * are applicable only to the data plot.
	 * @param	strColors	Comma separated list of colors that are to be used.
	*/
	public function setPaletteColors(strColors:String):Void{
		//Just store the list of colors after splitting
		this.colors = strColors.split(",");		
	}
	/**
