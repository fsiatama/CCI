...
class com.fusioncharts.helper.ToolTip {
	...
	*/
	...
	/**
	 * Resets the dimension of stage internally.
	 * @param sWidth	New width of stage
	 * @param sHeight	New height of stage
	*/
	function resetStage(sWidth:Number, sHeight:Number):Void{
		this.sWidth = sWidth;
		this.sHeight = sHeight;
	}
	/**
	...
	*/
	public function setParams(font:String, size:Number, color:String, bgColor:String, borderColor:String, isHTML:Boolean, dropShadow:Boolean, bold:Boolean, italic:Boolean) {
		//Store parameters in instance variables.
		this.font = font;
		this.size = size;
		this.color = color;
		...
		this.tFormat.bold = this.bold;
		this.tFormat.italic = this.italic;
