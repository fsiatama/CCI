...
class com.fusioncharts.core.chartobjects.Doughnut3D {
	 ...
	 */
	public function Doughnut3D(chartClassRef, mcTarget:MovieClip, mcPie:MovieClip, obj:Object, canvasXMin:Number, canvasXMax:Number) {
	...
	private function drawLabel():Void {
		...
		var type:String = objData.arrFinal['labelProps'][(objData.arrFinal['labelProps'].length-1)];
		var wrapSpaceObj:Number = objData.arrFinal['labelProps']['wrapSpace'];
		var maxYlimit:Number = objData.arrFinal['labelProps']['maxYlimit'];
