	...
	*/
	private function calculatePoints (isRedraw:Boolean)
	{
		...
		if(this.params.numVisiblePlot ==undefined || this.params.numVisiblePlot=="" || isNaN(this.params.numVisiblePlot)){
			...
			//Converted to number because it treated as string  and affects column space calculation (#FCXT-363)
			this.params.numVisiblePlot = Number(this.params.numVisiblePlot);
		}
