...
class com.fusioncharts.helper.ClickableLegend {
	...
	*/
	function ClickableLegend (targetMC:MovieClip, fontProp:Object, clickMode:Boolean, alignPos:String, xPos:Number, yPos:Number, maxWidth:Number, maxHeight:Number, allowDrag:Boolean, stageWidth:Number, stageHeight:Number, bgColor:String, bgAlpha:Number, borderColor:String, borderThickness:Number, borderAlpha:Number, scrollBgColor:String, scrollBarColor:String, btnColor:String){
	...
	*/
	public function addItem (itemName:String, itemColor:String, itemId:Number, active:Boolean){
	...
	*/
	public function clickEvent(index:Number):Void{
		...
		classRef.dispatchEvent({type:"legendClick", target:classRef, index:this.items[index].id, active:this.items[index].active, intIndex:index});
	}
	/**
