...
class adLDAP {
    ...
    * @var string
    */   
	protected $accountSuffix = "@minagricultura.gov.co";
    ...
    * @var string
    */
	protected $baseDn = "DC=minagricultura,DC=gov,DC=co"; 
    ...
    * @var array
    */
    protected $domainControllers = array("voltaire.minagricultura.gov.co", "neruda.minagricultura.gov.co");
