...
return [
    ...
    'reports' => [
		'mercado_nombre_help'   => 'Región o zona económica con la que se quiere medir el indicador',
		'indicador_nombre_help' => 'Nombre del reporte',
		'pais_help'             => 'País con el que se quiere medir el indicador',
		'posicion_help'         => 'Partida arancelaria del sistema armonizado de designación y codificación de mercancías (SA)',
		'sector_help'           => 'Sector específico del agro o de la agroindustria, por ejemplo: cereales, leguminosas, frutas y hortalizas, etc.',
		'total'                 => 'Total',
		'sectorSelected'        => 'Producto o sector seleccionado',
