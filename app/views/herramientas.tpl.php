				...
				<div class="panel-body">
						...
						<table class="table table-bordered table-tools">
							<tr>
								<td class="bg-success" colspan="2">
									<h4>Comercio agropecuario de <strong>Colombia</strong></h4>
								</td>
							</tr>
							<tr>
								<td class="col-md-11">
					...
					<div class="table-responsive">
						<table class="table table-bordered table-tools">
							...
							<tr>
								<td class="col-md-11"><p>Priorización de productos a partir de la demanda “Metodología de cuadrantes” – exploración preliminar de mercados</p></td>
								<td class="col-md-1">
					...
					<div class="table-responsive">
						<table class="table table-bordered table-tools">
							...
							<tr>
								<td class="col-md-11">
									<p>El siguiente link te permite consultar Las desgravaciones otorgadas a Colombia por producto, por País y con los años proyectados, así como los tamaños de los contingentes y la tasa extra contingente.</p>
								</td>
								<td class="col-md-1">
									<a href="<?= URL_RAIZ; ?>contingentes-desgravaciones">
										<i class="fa fa-2x fa-external-link"></i>
									</a>
								</td>
							</tr>
					...
					<div class="table-responsive">
						<table class="table table-bordered table-tools">
							...
							<tr>
								<td>
									<p>También dispones de los siguientes links para consultar los requisitos sanitarios de los siguientes paises</p>
									<ul>
										...
										<li><a target="_blank" href="http://www.inspection.gc.ca/food/eng/1299092387033/1299093490225">Canada</a></li>
								...
								<td>
									...
									<ul>
										...
										<li>
											México
											<ul>
												<li><a target="_blank" href="http://www.siicex.gob.mx/portalSiicex/Transparencia/CUPOS.htm">Información general sobre cupos</a></li>
												<li><a target="_blank" href="http://www.siicex.gob.mx/portalSiicex/Transparencia/rendecue.htm">Utilización de cupos</a></li>
												<li><a target="_blank" href="http://www.siicex.gob.mx/portalSiicex/SICETECA/Acuerdos/Cupos/Cupos%20x%20PRODUCTO/Cupos%20por%20producto.htm">Cupos por producto</a></li>
											</ul>
										</li>
					...
					<div class="table-responsive">
						<table class="table table-bordered table-tools">
							...
							<tr>
								...
								<td class="col-md-1">
									<a target="_blank" href="http://www.trademap.org/Index.aspx?lang=es">
										<i class="fa fa-2x fa-external-link"></i>
									</a>
								</td>
							</tr>
