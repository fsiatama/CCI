...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="<?= URL_RAIZ; ?>css/magicsuggest-min.css" />
        
        <link rel="stylesheet" type="text/css" href="<?= URL_RAIZ; ?>css/layout.css" />
    ...
    <body>
                ...
                <div class="container">
                    ...
                    <div class="navbar-header">
                        <a class="navbar-brand" href="<?= URL_RAIZ; ?>">
                            ...
                            <img class="img-responsive hidden-xs hidden-sm hidden-md" src="<?= URL_RAIZ; ?>img/logo_home.png" alt="www.minagricultura.gov.co" width="248" height="80" />
                        </a>
                    </div>
        ...
        <script type="text/javascript" src="<?= URL_RAIZ; ?>js/vendor/bootstrap.min.js"></script>
        <script type="text/javascript" src="<?= URL_RAIZ; ?>js/magicsuggest-min.js"></script>
        <script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?v=3"></script>
        <script type="text/javascript" src="<?= URL_RAIZ; ?>js/plugins.js"></script>
        <script type="text/javascript" src="<?= URL_RAIZ; ?>js/main.js"></script>
    </body>
</html>
