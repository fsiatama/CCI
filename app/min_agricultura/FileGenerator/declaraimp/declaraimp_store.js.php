...
var cmDeclaraimp = new Ext.grid.ColumnModel({
	columns:[
		...
		{xtype:'datecolumn', header:'<?= Lang::get('declaraimp.columns_title.fecha'); ?>', align:'left', hidden:false, dataIndex:'fecha', format:'Y-m-d'},
		...
		{xtype:'numbercolumn', header:'<?= Lang::get('declaraimp.columns_title.id_deptorigen'); ?>', align:'right', hidden:false, dataIndex:'id_deptorigen'},
	...
	,items:[{
		...
		,items:[{
			...
			,items:[{
				xtype:'datefield'
				,name:'fecha'
				,fieldLabel:'<?= Lang::get('declaraimp.columns_title.fecha'); ?>'
				,id:module+'fecha'
				,allowBlank:false
			}]
		},{
			...
			,items:[{
				xtype:'numberfield'
				,name:'id_deptorigen'
				,fieldLabel:'<?= Lang::get('declaraimp.columns_title.id_deptorigen'); ?>'
			...
			,items:[{
				xtype:'numberfield'
				,name:'arancel_pagado'
				,fieldLabel:'<?= Lang::get('declaraimp.columns_title.arancel_pagado'); ?>'
				,id:module+'arancel_pagado'
				,allowBlank:false
			}]
		},{
			defaults:{anchor:'100%'}
