...
var formDesgravacion_det = new Ext.FormPanel({
	...
	,items:[{
		...
		,items:[{
			...
			,items:[{
				xtype:'numberfield'
				,name:'desgravacion_det_tipo_operacion'
				,fieldLabel:'<?= Lang::get('desgravacion_det.columns_title.desgravacion_det_tipo_operacion'); ?>'
				,id:module+'desgravacion_det_tipo_operacion'
				,allowBlank:false
			}]
		},{
			defaults:{anchor:'100%'}
