...
class Acuerdo_info {
	...
	public function setAcuerdo_estado($acuerdo_estado){
		$this->acuerdo_estado = $acuerdo_estado;
	}

	public function getAcuerdo_estado(){
		return $this->acuerdo_estado;
	}

	public function getAcuerdoEstadoTitleAttribute($key)
	{
		return Lang::get('acuerdo_info.acuerdo_estado.' . $key);
	}
